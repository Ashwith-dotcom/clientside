...
import { Users, Utensils, Building2, Heart } from 'lucide-react';
  ...
  return (
    <div ref={containerRef} className="py-20 bg-orange-50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-orange-600 mb-16">Our Impact</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {impactData.map((item, index) => (
            <div key={index} className="impact-item text-center p-6 bg-white rounded-xl shadow-lg">
